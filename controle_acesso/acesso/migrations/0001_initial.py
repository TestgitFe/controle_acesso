    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pessoa', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='veiculos', to='acesso.pessoa')),
            ],
        ),
        migrations.CreateModel(
            name='RegistroAcesso',
            fields=[
                ...
                ('status', models.CharField(choices=[('E', 'Em andamento'), ('F', 'Finalizado')], default='E', max_length=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pessoa', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='enderecos', to='acesso.pessoa')),
            ],
        ),
        migrations.CreateModel(
            name='Funcionario',
